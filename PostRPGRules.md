...
2. **Резерв:** выбери ещё **3** хода - изначально закрыты. В конце своего хода, если в текущем цикле **не** разыгрывал умный ход, брось `1d6`: `1–3` ничего `4` - можно открыть 1-й (если не открыт), `5` - 2-й, `6` - 3-й. Открытые тактики остаются доступными до конца боя.
