...
**Требуется:** `-`  
**Эффект:** `+2` к броскам атаки **гранатами**; получаешь `2` гранаты в инвентарь. TODO (молотов?)

#### 🧨 Подрывник

*Гром - твой аргумент, осколки - твоя подпись. И ты знаешь, какой провод резать.*  
**Требуется:** `INT 4+`  
**Эффект:** `+1` к урону всеми **взрывами** (гранаты, ракеты, взрывчатка и т.п.); получаешь `2` гранаты в инвентарь;
игнорируешь натуральную `1` при атаке метательным: считай бросок как `2` (без неприятности). TODO (молотов?)
