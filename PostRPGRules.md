...
4. **Одноразовые ходы:** некоторые умные ходы помечены как **ОДНОРАЗОВЫЕ** - после применения исчезают из твоего списка на весь бой.

### Список умных ходов по стоимости

**Стоимость 1**

* **Подкрутка (ДЕЙСТВИЕ):** к своему броску `d20` `+1` (можно применять после своего броска).
...
* **Согласованный огонь (ДЕЙСТВИЕ):** по выбранной цели до твоего следующего хода первый союзник получает `+2` к одному
  броску атаки.
* **Подавление (ДЕЙСТВИЕ):** если твоя дальняя атака **попала**, цель получает `−2` к атакам до конца своего следующего
  хода (нужно применять до броска своего `1d20`).
* **Шумовая отвлекашка (ДЕЙСТВИЕ):** цель теряет половину `AC` (округлить в большую сторону) за укрытия до конца твоего хода.

**Стоимость 2**

* **Переброс (ДЕЙСТВИЕ)(ОДНОРАЗОВЫЙ):** перебрось свой `d20` и возьми лучший (можно применять после своего броска).
* **Координация (ДЕЙСТВИЕ):** немедленно перемести одного союзника на короткое перемещение.
