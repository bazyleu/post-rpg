...
* **Криты:** натуральная (без модификаторов) `20` - попадание **+ модификатор оружия**; натуральная `1` - промах **+ неприятность**.
...
* **Адреналин (ДЕЙСТВИЕ):** восстанови себе `1 HP` (не выше максимума).
* **Согласованный огонь (ДЕЙСТВИЕ):** по выбранной цели до твоего следующего хода первый союзник получает `+2` к одному броску атаки.
